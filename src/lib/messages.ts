...
> = {
  "pt-BR": {
    ...
    continueJourney: {
      ...
      ricardoEntryProductLine: "Caixa Horizon Three Wireless",
      ricardoEntryBody:
    ...
    spotlight: {
      ...
      ricardoHeadline: "Caixa Horizon One Wireless",
      ricardoBody:
    ...
    cart: {
      ...
      bundleDefBndEraPairRoamTitle: "Kit multiambiente — 2 salas Horizon + Trail Mini",
      bundleDefBndEraPairRoamBody: "Estéreo ou dois cômodos, mais uma caixa de viagem no mesmo pacote",
      bundleDefBndMoveRoamTitle: "Dúo externo — Trail Max + Trail Mini",
      bundleDefBndMoveRoamBody: "Força na varanda e backup de bolso para viagens",
      bundleDefBndEraMoveTitle: "Dentro e fora — Horizon One + Trail Max",
      bundleDefBndEraMoveBody: "Caixa para o cômodo e som resistente para varanda e viagem",
      bundleDefBndArcSubTitle: "Home theater premium — Stage Ultra + SubStage Pro",
      bundleDefBndArcSubBody: "Barra Atmos de referência com graves profundos no pacote",
      bundleDefBndBeamRoamTitle: "TV + bolso — Stage Compact (Gen 2) + Trail Mini",
    ...
    searchSerp: {
      ...
      learningPortableBody:
        "Trail Mini e Trail Max foram feitos para levar; a linha Horizon ancora a sala com mais corpo sonoro.",
