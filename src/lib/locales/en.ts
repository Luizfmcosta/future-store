/** English UI bundle (source of truth for keys). */
export const enMessages = {
    ...
    homeWelcome: {
      ...
      languageGroupAria: "Choose interface language",
      precacheTooltipUnknown: "Offline cache: …",
      precacheTooltipUnsupported: "Offline cache: not available here",
      precacheTooltipDisabled: "Offline cache: off in dev (build + prod to precache)",
      precacheTooltipStarting: "Offline cache: starting…",
      precacheTooltipChecking: "Offline cache: checking…",
      precacheTooltipInstalling: "Offline cache: saving {done}/{total}…",
      precacheTooltipInstallDone: "Offline cache: complete ({ok}/{total})",
      precacheTooltipInstallPartial: "Offline cache: {ok}/{total} · {failed} skipped",
      ...
      hardResetReloadWorking: "Clearing…",
    },
    profileCard: {
      expand: "Expand",
      collapse: "Collapse",
