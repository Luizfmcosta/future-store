...
/** Horizon Three ships in natural oak only (matches hero photo). */
const COLORS_HORIZON_THREE: ProductColorOption[] = [
  { labelKey: "naturalOak", swatchHex: "#d2c2a8", matchesPhoto: true },
];
...
export const products: Product[] = [
  ...
  },
  {
    ...
    gallery: [
      ...
      media("horizon3-2.png"),
      media("horizon3-3.png"),
    ],
    description:
    ...
    colorOptions: COLORS_HORIZON_THREE,
  ...
  /** TVs — entry / mid tier for promo funnels (Ricardo). */
  {
    ...
    deliveryETA: "5–10 business days",
    stock: 128,
    inches: 50,
    technology: "LED",
    reviewStrengths: [
      "Sharp 4K panel with solid contrast in bright rooms",
      "Smart hub with streaming apps and casting",
      "3× HDMI — ready for a console and soundbar",
    ],
    reviewWeaknesses: ["No advanced local dimming like premium mini-LED sets"],
    returnPolicyShort: "7 days (sealed)",
    warrantyShort: "12 months manufacturer",
    compatibilityTags: ["4K", "HDR10+", "WiFi", "Bluetooth"],
    bestFor: ["Compact living rooms", "Series and movies", "First 4K"],
    marginTier: "mid",
    sponsored: true,
  ...
  },
  {
    ...
    deliveryETA: "4–8 business days",
    stock: 94,
    inches: 50,
    technology: "LED",
    reviewStrengths: [
      "Smart OS with voice search",
      "Strong inch-to-price value for mid-size rooms",
      "Game mode with low latency",
    ],
    reviewWeaknesses: ["Basic speakers — pair with a soundbar for movies"],
    returnPolicyShort: "7 days (sealed)",
    warrantyShort: "12 months manufacturer",
    compatibilityTags: ["4K", "Dynamic HDR", "WiFi", "Bluetooth"],
    bestFor: ["Daily streaming", "Casual gaming", "Large bedrooms"],
    marginTier: "mid",
  ...
  },
  {
    ...
    technology: "LED",
    reviewStrengths: [
      "Fast smart OS with pointer remote included",
      "55\" comfortable at ~2.5 m viewing distance",
      "Cinema mode for natural-looking series and films",
    ],
    reviewWeaknesses: ["IPS panel — lower contrast than high-contrast panels in dark rooms"],
    returnPolicyShort: "7 days (sealed)",
    warrantyShort: "12 months manufacturer",
    compatibilityTags: ["4K", "HDR10", "WiFi", "Bluetooth"],
    bestFor: ["Living room", "Sports", "Families"],
    marginTier: "mid",
    sponsored: true,
  ...
  {
    id: "hp-apex-shadow",
    sku: "FS-HP-APEX-SHD-BLK",
    category: "speaker",
    title: "Apex Shadow — Wireless ANC over-ear headphones",
    brand: "Future Sound",
    price: 1799,
    installmentText: "10x R$ 179,90 sem juros",
    deliveryETA: "3–5 business days",
    stock: 85,
    reviewStrengths: [
      "Hybrid ANC with ambient passthrough when you need it",
      "40 mm drivers tuned for detail and low-end extension",
      "Bluetooth 5.3 multipoint — laptop and phone at once",
      "USB-C fast charge; up to 50h playback with ANC off",
    ],
    reviewWeaknesses: [
      "Over-ear fit runs warm on long summer sessions",
    ],
    returnPolicyShort: "30 days",
    warrantyShort: "24 months manufacturer",
    compatibilityTags: [
    ...
    bestFor: ["Commuting", "Open offices", "Hi-res streaming on the go"],
    marginTier: "mid",
    heroImage: media("Apex Shadow Wireless ANC.png"),
    gallery: [media("Apex Shadow Wireless ANC.png")],
    description:
      "Apex Shadow is a stealth-black over-ear with hybrid ANC, plush memory-foam cushions, and a premium matte finish. Multipoint Bluetooth 5.3 keeps your laptop and phone connected, while USB-C fast charging and long battery life cover full work weeks between top-ups.",
    colorOptions: [{ labelKey: "matteBlack", swatchHex: "#1a1a1a" }],
    reviewRating: RR(4.6, 1284),
  },
  {
    id: "hp-aether-buds",
    sku: "FS-HP-AETHR-WHT",
    category: "speaker",
    title: "Aether Buds — True wireless earbuds with charging case",
    brand: "Future Sound",
    price: 2199,
    ...
    stock: 142,
    reviewStrengths: [
      "Stemless ergonomic fit with secure in-ear seal",
      "Compact flip case with magnetic dock and LED charge hint",
      "Dual acoustic vents for pressure relief on long wears",
      "Quick pairing and stable Bluetooth 5.3 link",
    ],
    reviewWeaknesses: [
      "No ANC — see Apex Shadow for travel isolation",
    ],
    returnPolicyShort: "30 days",
    warrantyShort: "12 months manufacturer",
    compatibilityTags: ["Bluetooth 5.3", "USB-C case charging", "IPX4 earbuds", "AAC / SBC"],
    bestFor: ["Everyday carry", "Calls and podcasts", "Gym and travel kits"],
    marginTier: "mid",
    sponsored: true,
    heroImage: media("Aether Buds Wireless Earbuds.png"),
    gallery: [media("Aether Buds Wireless Earbuds.png")],
    description:
      "Aether Buds are true wireless earbuds in a matte white stemless design, paired with a minimal flip-top charging case. The case recharges over USB-C; earbuds snap in magnetically. A strong pick for daily calls, music, and workouts where you want a light, pocketable set.",
    colorOptions: [{ labelKey: "lunarWhite", swatchHex: "#e8e6e1" }],
    reviewRating: RR(4.5, 3102),
  },
];
