    ...
    <AnimatePresence>
      {open ? (
        <motion.div
          ...
          role="presentation"
        >
          <button type="button" className="absolute inset-0 bg-black/55 backdrop-blur-md" onClick={close} aria-label={t("cart.close")} />
          <motion.aside
            role="dialog"
            aria-modal="true"
            ...
            className="absolute right-0 top-0 h-full w-full max-w-md border-l border-stone-200/90 bg-white/98 text-stone-900 shadow-2xl backdrop-blur-2xl"
          >
